	...
	if (req.body.grant_type == 'authorization_code') {
		...
		if (code) {
			...
			if (code.request.client_id == clientId) {
				...
				var expires_in = 300;
				nosql.insert({ access_token: access_token, client_id: clientId, expires_in: Date.now() + DEFAULT_EXPIRE_TIME });

				var token_response = { access_token: access_token, token_type: 'Bearer', expires_in: expires_in };
